...
-- AddForeignKey
ALTER TABLE "public"."Upload" ADD CONSTRAINT "Upload_driverId_fkey" FOREIGN KEY ("driverId") REFERENCES "public"."User"("driverId") ON DELETE SET NULL ON UPDATE CASCADE;
