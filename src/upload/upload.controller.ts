...
  Get,
  Patch,
  Param, // <-- Make sure Param is imported
} from '@nestjs/common';
...
  // --- NEW DAILY ROUTES (MUST GO *BEFORE* /payroll/:driverId) ---
...
  @Get('payroll/:driverId') // <-- This existing route MUST come after the new daily routes
